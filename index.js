...
function checkArray(obj) {
  ...
  //Повертаємо false
  if (Array.isArray(obj) !== null && Array.isArray(obj) !== undefined) {
    return true;
  } else {
    false;
  }
...
function findElementIndexes(arr, element) {
  ...
  let firstArr = arr.indexOf(element);

  let lastArr = arr.lastIndexOf(element);

  let arrIndex = [];

  if (firstArr != 0) {
    arrIndex.push(firstArr);
  }

  if (lastArr != firstArr) {
    arrIndex.push(lastArr);
  }
